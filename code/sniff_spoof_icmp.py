...
if __name__ == "__main__":
  ...
  sniff(iface=sys.argv[1], filter='icmp and src host 10.0.2.15',prn=spoof_pkt) #icmp and src host 10.0.2.15  sniff(iface=sys.argv[1], filter='icmp and src host 10.0.2.15',prn=spoof_pkt) #icmp and src host 10.0.2.15